...
describe('Event Service', function() {
  describe('Compute date range', function() {
    it('computes end date if not specified', function() {
      ...
      const actualDateRange = EventService.getDateRange(new Date("2017-11-01"));
    ...
    it('returns the specified end date', function() {
      ...
      const actualDateRange = EventService.getDateRange(new Date("2017-11-01"), new Date("2017-12-24"));
